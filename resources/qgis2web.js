...
map.getView().fit([11752777.879481, 1011431.363244, 12356463.478053, 35144474.178218], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">chua kho me</h2>';
        return titleElement;
    })(),
